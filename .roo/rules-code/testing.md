...
- when you want to run unit test in either of the sub projects (frontend or domain), you can use the command 'npx vitest run <path/to/file>' from the root folder of the sub project.
