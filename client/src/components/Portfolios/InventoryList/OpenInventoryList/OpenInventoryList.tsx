...
import "./OpenInventoryList.css";

type OpenInventoryListProps = Props<{ portfolioName: string }>;

const { bemBlock, bemElement } = bemHelper("open-inventory-list");
...
const TABLE_HEADERS = ["Asset", "Pieces", "Invested Value", "Fees"];
...
function getInventoryRows(
  ...
  return Object.keys(portfolio.orders)
    .map((isin) => ({
      ...
      invested: getInvestedValueOfIsinInPortfolio(portfolio, isin, "open"),
